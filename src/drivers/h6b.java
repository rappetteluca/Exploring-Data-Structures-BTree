...
public class h6b {
	...
	private void rangeSearch (DBTable t, int low, int high) throws IOException {
	...
	public h6b() throws IOException {
		...
		t2 = new DBTable("testdata/f2", t2Fields, 132);
		t3 = new DBTable("testdata/f3", t3Fields, 72);

		//Insert data into t1
		insert_t1("testdata/authors.txt");
		...
		rangeSearch(t2, 0, limit);

		System.out.println("Range Search t3");
		rangeSearch(t3, 0, 100);
		...
		t2 = new DBTable("testdata/f2");
		t3 = new DBTable("testdata/f3");
